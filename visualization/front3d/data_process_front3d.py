...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='../../datasets/output/prosessed_3dfront_data_V3',
...
if __name__ == '__main__':
    ...
    base_rendering_path = "/localhome/xsa55/Xiaohao/SemDiffLayout/datasets/front_3d_with_improved_mat/renderings_V3"
