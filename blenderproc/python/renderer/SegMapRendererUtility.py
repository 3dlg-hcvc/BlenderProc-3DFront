                ...
                for channel_id in range(result_channels):
                    ...
                    if current_attribute == "instance":
                        ...
                        for object_id in object_ids:
                            ...
                            if attribute != "height" and attribute != "orientation" and attribute != "size" and attribute != "scale":
                            ...
                            if current_attribute == "height":
                                try:
                                    value = current_obj.original.location[2]
                                except:
                                    value = None
                            if current_attribute == "size":
                                try:
                                    value = np.asarray(current_obj.original.dimensions)
                                    value[[1, 2]] = value[[2, 1]]
                                    value = value.tolist()
                                except:
                                    value = None
                            if current_attribute == "scale":
                                try:
                                    value = np.asarray(current_obj.original.scale)
                                    value[[1, 2]] = value[[2, 1]]
                                    value = value.tolist()
                                except:
                                    value = None
